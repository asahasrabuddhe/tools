...
// To install gonew:
//
//	go install github.com/asahasrabuddhe/tools/cmd/gonew@latest
//
...
import (
	...
	"github.com/asahasrabuddhe/tools/internal/edit"
...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "See https://pkg.go.dev/github.com/asahasrabuddhe/tools/cmd/gonew.\n")
	os.Exit(2)
}
