...
func TestSpecialOld(t *testing.T) { // exercises lcs.fix
	a := "github.com/asahasrabuddhe/tools/intern"
	b := "github.com/google/safehtml/template\"\n\t\"github.com/asahasrabuddhe/tools/intern"
...
func TestRegressionOld001(t *testing.T) {
	a := "// Copyright 2019 The Go Authors. All rights reserved.\n// Use of this source code is governed by a BSD-style\n// license that can be found in the LICENSE file.\n\npackage diff_test\n\nimport (\n\t\"fmt\"\n\t\"math/rand\"\n\t\"strings\"\n\t\"testing\"\n\n\t\"github.com/asahasrabuddhe/tools/gopls/internal/lsp/diff\"\n\t\"github.com/asahasrabuddhe/tools/internal/diff/difftest\"\n\t\"github.com/asahasrabuddhe/tools/gopls/internal/span\"\n)\n"
