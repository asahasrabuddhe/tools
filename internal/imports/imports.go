...
// Options is github.com/asahasrabuddhe/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/asahasrabuddhe/tools/imports.Process with explicit context in opt.Env.
