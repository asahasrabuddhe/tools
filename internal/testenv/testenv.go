...
import (
	...
	"github.com/asahasrabuddhe/tools/internal/goroot"
...
// NeedsLocalXTools skips t if the github.com/asahasrabuddhe/tools module is replaced and
...
func NeedsLocalXTools(t testing.TB) {
	...
	cmd := Command(t, "go", "list", "-f", "{{with .Replace}}{{.Dir}}{{end}}", "-m", "github.com/asahasrabuddhe/tools")
	out, err := cmd.Output()
	if err != nil {
	...
	if want := "github.com/asahasrabuddhe/tools"; modulePath != want {
