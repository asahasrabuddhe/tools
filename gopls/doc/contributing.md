...
Most of the `gopls` logic is in the `github.com/asahasrabuddhe/tools/gopls/internal`
...
```bash
$ gopls version
github.com/asahasrabuddhe/tools/gopls master
    github.com/asahasrabuddhe/tools/gopls@(devel)
```
...
both the `github.com/asahasrabuddhe/tools` and `github.com/asahasrabuddhe/tools/gopls` modules, as
described above.
