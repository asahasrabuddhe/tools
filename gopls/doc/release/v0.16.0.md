...
-->
```
go install github.com/asahasrabuddhe/tools/gopls@v0.16.0-pre.2
```
...
The new
[unusedwrite](https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/passes/unusedwrite)
...
The new
[`stdversion`](https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/passes/stdversion)
...
The [framepointer](https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/passes/framepointer)
and [sigchanyzer](https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/passes/sigchanyzer)
