...
```sh
$ go install github.com/asahasrabuddhe/tools/gopls@vX.Y.Z
```
...
go get -d github.com/asahasrabuddhe/tools/gopls@master github.com/asahasrabuddhe/tools@master

go install github.com/asahasrabuddhe/tools/gopls
```
