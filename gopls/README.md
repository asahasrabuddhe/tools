...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/asahasrabuddhe/tools/gopls)](https://pkg.go.dev/github.com/asahasrabuddhe/tools/gopls)
...
```sh
go install github.com/asahasrabuddhe/tools/gopls@latest
```
