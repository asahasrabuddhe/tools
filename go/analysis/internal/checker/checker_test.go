...
import (
	...
	"github.com/asahasrabuddhe/tools/go/analysis/internal/checker"
	"github.com/asahasrabuddhe/tools/go/analysis/passes/inspect"
	"github.com/asahasrabuddhe/tools/go/ast/inspector"
	"github.com/asahasrabuddhe/tools/internal/testenv"
	"github.com/asahasrabuddhe/tools/internal/testfiles"
...
func TestURL(t *testing.T) {
	...
	pkgname := &analysis.Analyzer{
		...
		URL:  "https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/internal/checker",
	...
	want := []string{"https://pkg.go.dev/github.com/asahasrabuddhe/tools/go/analysis/internal/checker"}
